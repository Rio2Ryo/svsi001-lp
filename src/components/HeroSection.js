        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-thin text-white leading-tight">
              朝の
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#B8860B] to-[#D4C4B0]">
                5秒
              </span>
              で、<br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              ...
              >
                ...
                <span className="relative text-white text-sm tracking-wider font-medium">購入する</span>
              </button>
            ...
            <div className="flex items-center justify-center gap-8 md:gap-12 pt-8">
              {/* 朝5秒 */}
              <FeatureIcon icon="clock" text="朝5秒で完成" />
              {/* 24時間キープ */}
              <FeatureIcon icon="star" text="24時間キープ" />
              {/* 医薬部外品 */}
              <FeatureIcon icon="check" text="医薬部外品" />
            </div>
          </div>
